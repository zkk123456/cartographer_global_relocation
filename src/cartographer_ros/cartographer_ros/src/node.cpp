    ...
    : node_options_(node_options)
{
  ...
  //HandleRelocationService
  relocation_server_ = node_->create_service<cartographer_ros_msgs::srv::RelocationService>(
      kRelocationServiceName,
      std::bind(
          &Node::HandleRelocationService, this, std::placeholders::_1, std::placeholders::_2));

  load_trajectory_server_ = node_->create_service<cartographer_ros_msgs::srv::LoadStateFromFile>(
      kLoadStateFromFileServiceName,
      std::bind(
          &Node::HandleLoadStateFromFile, this, std::placeholders::_1, std::placeholders::_2));
  LOG(INFO) << "delete_trajectory_server_";
...
bool Node::handleReadMetrics(
  ...
  // TODO: do we need sth like trajectories_scheduled_for_finish_ ?
...
bool Node::HandleLoadStateFromFile(
     const cartographer_ros_msgs::srv::LoadStateFromFile::Request::SharedPtr request,
      cartographer_ros_msgs::srv::LoadStateFromFile::Response::SharedPtr response)
 {
  // TODO: lock?
...
bool Node::HandleRelocationService(
      const cartographer_ros_msgs::srv::RelocationService::Request::SharedPtr request,
      cartographer_ros_msgs::srv::RelocationService::Response::SharedPtr response)
{
  LOG(INFO) << "HandleRelocationService : '" << request->min_score << "'...";
  geometry_msgs::msg::Pose new_pose;
  //map_builder_bridge_->RelocationService(request->min_score,&new_pose);
