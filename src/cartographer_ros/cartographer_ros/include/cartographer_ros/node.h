...
#include "cartographer_ros_msgs/srv/load_state_from_file.hpp"
#include "cartographer_ros_msgs/srv/relocation_service.hpp"
...
class Node {
 ...
 private:
  ...
  ::rclcpp::Service<cartographer_ros_msgs::srv::LoadStateFromFile>::SharedPtr load_trajectory_server_;
  ::rclcpp::Service<cartographer_ros_msgs::srv::RelocationService>::SharedPtr relocation_server_;
